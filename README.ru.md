...
<p align="center">
  ...
  Codex или Claude Code за рулём. Вы поставляете vanilla JS для браузера.
</p>
...
- 📦 **Vanilla JS + Canvas runtime** — у сгенерированных игр нет зависимости от фреймворков. Залейте папку на GitHub Pages — и всё работает.
...
**Движки**: Web (vanilla JS + Canvas) — основной таргет, активно развивается. Godot 4 продолжает работать для legacy-проектов; новых фич для Godot не добавляется.
